...
namespace HomeWork2
{
    public partial class Task5 : Form
    {
        ...
        {
            if (button.Location.X - 20 < mouse.X || button.Location.X + button.Width + 20 < mouse.X)
            {                
                return true;
            }else if(button.Location.Y - 20 < mouse.Y || button.Location.Y + button.Height + 20 < mouse.Y)
            {
                return true;
            }
            return false;
        ...
        private bool isBorder(Button button)
        {
            if(button.Location.X + button.Width == this.Width - 10 || button.Location.X == 10)
            {
                return false;
            }else if(button.Location.Y + button.Height - 10 == this.Height || button.Location.Y == 10)
            {
                return false;
            }
